...
- **Reference repos read:** `openclaw` (primary), `letta` (primary), `mem0` (primary), `codex` (primary), `claude-code` (secondary), `gemini-cli` (secondary), `tinyclaw` (secondary)
