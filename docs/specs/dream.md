...
This spec owns the dream-cycle lifecycle. The broader persistent cognition model lives in [memory-session.md](memory-session.md) and [memory-knowledge.md](memory-knowledge.md). Startup and shutdown sequencing live in [bootstrap.md](bootstrap.md) and [system.md](system.md). Prompt injection and recall scoring live in [prompt-assembly.md](prompt-assembly.md). Model routing for dream miner and merge calls lives in [llm-models.md](llm-models.md).
