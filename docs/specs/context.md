...
| `summarize_history_window` | when history exceeds compaction threshold, keeps head + summary marker + tail; summarizer uses structured template (Goal, Key Decisions, User Corrections, Errors & Fixes, Working Set, Progress, Next Step) |
