...
Snapshot placement in the compacted history: `head | marker | [todo_snapshot] | [search breadcrumbs] | tail`. See [compaction.md](compaction.md) for the full assembly pipeline.
