...
Start with [System Design](DESIGN-core.md) for the architecture overview, then dive into component docs grouped by layer:
...
- **Tools** — Shell (approval-gated), Obsidian vault, Google services, and web tools. Each tool follows the `RunContext[CoDeps]` pattern.
