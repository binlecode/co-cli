...
``load_standing_artifacts`` but cannot import from ``co_cli.tools`` (cycle).
This module re-exports the canonical loaders from ``co_cli.knowledge._artifact``
to sit outside that cycle.
"""
