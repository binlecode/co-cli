...
You MUST only use content from the conversation window to identify memory signals. Do not attempt to investigate or verify content further — no grepping source files, no reading code to confirm a pattern exists.
