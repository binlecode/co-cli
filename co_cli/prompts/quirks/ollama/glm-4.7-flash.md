---
flags: [overeager, verbose]
inference:
  # Source: https://huggingface.co/zai-org/GLM-4.7-Flash (tool-calling/SWE-Bench profile)
  # temperature=0.7 + top_p=1.0: use one sampling axis; nucleus off when temp is set.
  # repeat_penalty MUST be 1.0 — any value above 1.0 causes degenerate repetition loops.
  # num_ctx 202752: Unsloth GGUF rope-scaled figure; Ollama library lists 198K.
  temperature: 0.7
  top_p: 1.0
  max_tokens: 16384
  num_ctx: 202752
...
Always respond in English. Do not switch to Chinese or any other language mid-session, even for reasoning traces.

Keep responses concise. Do not generate verbose internal reasoning for simple requests — answer directly.
