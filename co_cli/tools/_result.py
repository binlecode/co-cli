...
tool returns to dict before _stream_events() sees them, so isinstance(content,
...
# Shared type alias for FrontendProtocol.on_tool_complete, _stream_events dispatch,
