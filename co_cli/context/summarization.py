...
_SUMMARIZE_PROMPT = (
    ...
    "Use these sections:\n\n"
    "## Active Task\n"
    "Copy the user's most recent request word-for-word (1–2 sentences max). Do not paraphrase.\n"
    "This is the primary continuity anchor — the resuming model must see exactly what the user asked.\n\n"
    "## Goal\n"
