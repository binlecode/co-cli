...
Implementation-level direct-helper coverage belongs in pytest. Full per-turn
recall injection already lives in ``evals/eval_memory_recall.py``.
...
from evals._timeouts import EVAL_MEMORY_EXTRACTION_TIMEOUT_SECS
