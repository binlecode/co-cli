...
from co_cli.memory.session_store import SessionSearchResult, SessionStore
...
# ---------------------------------------------------------------------------
# TASK-1 test 2: SessionStore.index_session populates tables; FTS row count matches
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# TASK-1 test 3: SessionStore.search returns SessionSearchResult with correct session_id
# ---------------------------------------------------------------------------
